...
Genau diese eben beschriebenen Perspektiven bilden die methodische Grundlage für die im Rahmen unserer Arbeit durchgeführten Validierungsstudie. Um die Validität des portablen EEG-Systems zu bewerten, müssen deshalb beide Betrachtungsweisen bedacht werden. Deshalb  wird zum einen die \textbf{Alpha-Power} stellvertretend für die spontanen Rhythmen herangezogen, zum anderen die\textbf{P1-Komponente} stellvertretend für die ereignisbezogenen Potenziale. \newline 
Im folgenden werden deshalb zunächst die Frequenzbandbereiche (Abschnitt \ref{sec:frequenzbaender}) und anschließend die ERPs (Abschnitt \ref{sec:erps}) erläutert, wobei ein besonderer Fokus auf die in unserer Studie gewählten Vergleichsgrößen gelegt wird. Alle weiteren  Bändern bzw. Komponenten können ausführlicher beschrieben auch im Anhang gefunden werden. \ref{app:frequenzbaender} und \ref{app:erp} Abschließend werden auch allgemeine Störgrößen behandelt, die später bei der Verarbeitung der in der Studie aufgenommenen Rohdaten beachtet werden müssen (Abschnitt \ref{sec:stoergroessen}). 
...
Werden die  assoziierten mentalen und physiologischen Zuständebetrachtet lässt sich feststellen, dass niedrige Frequenzen wie Delta-Wellen vor allem in tiefen Schlafphasen dominieren, während höhere Frequenzen wie Beta- und Gamma-Wellen mit aktiver kognitiver Verarbeitung und Aufmerksamkeit assoziiert sind.Es ist jedoch zu beachten, dass diese Zuordnungen keine eindeutigen Zustände darstellen, da im Gehirn meist mehrere Frequenzbereiche gleichzeitig aktiv sind und sich überlagern.
...
Die korrekte Abbildung des Alpha-Rhythmus eignet sich besonders gut als Kiterium, um zwei EEG-Systeme miteinander zu vergleichen, da das auftreten dieses aufgrund des Hans-Berger-Effektes sehr gut vorhersagbar ist. Konkret bedeutet das, dass beim schließen der Augen das ansteigen der Alpha-Power zu erwarten ist und beim öfnnen der Augen das sinken dieser. .\footnote{Vgl. Ebd.} Zusätzlich ist dieses Phänomen sehr gut untersucht und sehr einfach als Teil des Versuches durchzuführen. ( Vgl. \ref{sec:Methodik}) 


\subsection{Bedeutung und Anwendungen der Frequenzbänder in BCI-Systemen}

 Die Frequenzbandanalyse ist auch für viele Anwendungen von besonderer Bedeutung. Im klinischen Kontext werden EEG-Rhythmen genutzt, um Anomalien zu identifizieren und BCI-Forscher entwickeln Systeme zur gezielten Modulation bestimmter Bänder. Eine klassische Applikation ist das Nutzen der Alpha- oder Beta-Rhythmusmodulation für die BCI-Steuerung, wie Beispielsweise, wenn eine Person lernt, ihre Alpha-Leistung zu Steigern, um einen Befehl auszuführen oder die Mu-/Beta-Suppression um eine Prothese zu steuern. Studien zeigten, dass eine einfache binäre Kontrolle durch die Erkennung von Veränderungen im EEG erreicht werden kann. In einer frühen Demonstration erlernte ein gelähmter Patient Beta Aktivität zu nutzen, um einen Schalter zu bedienen, welcher einen Computer Cursor bewegte und zusätzlich elektrische Stimulatoren für seine Hand aktivierte. Dadurch konnte der Patient ein gewisses Maß an Bewegungsfreiheit zurückgewinnen.\footnote{Vgl. \cite{uchida1991}} 
...
Im nächsten Abschnitt werden vor allen Dingen die charakteristischen Merkmale der P1-Komponnte betrachtet, da diese Komponente als weiteres Vergleichskriterium unserer Validierungsstudie dient. Alle weiteren ausführlichen Beschreibungen der anderen komponenten finden sich im Anhang
\ref{app:erp}. \newline
...
Die positive P1-Komponente erreicht an den lateral okzipitalen Elektroden ihre maximale Amplitude und tritt 60-90 ms nach dem Reiz auf und erreicht ihr Maximum bei 100-130 ms. Sie ist allerdings schwierig genau zu identifizieren, da sie sich mit der C1-Welle überlappt. Zusätzlich ist anzumerken, dass die P1-Latenz- und Amplitude sich maßgeblich durch den Stimuluskontrast verändern kann.\footnote{Vgl. Ebd., S. 36}\newline

Genau diese Eigenschaften der P1 sind ausschlaggebend für die Eignung als Validierungskriterium für unere Studie: Erstens kann die Auswertung hauptsächlich auf die lateral okzipitalen Elektroden beschränkt werden, da die P1 ihre maximale Amplitude an diesen Elektroden erreicht und zweitens lässt sich das Verhalten der P1 gegenüber Kontrast- und Größenabhängigkeit des Stimulus gut vorhersagen. Dies bedeutet in der Praxis, dass die P1, wenn Proband/innen ein großes und kontrastreiches Bild sehen eine geringere Latenz und größere Amplitude aufweisen müsste, als wenn sie ein kleines Bild mit geringem Kontrast sehen. 
