...
% EBD-FIX: Diese Fußnote zitierte im Original ein zweites Mal direkt
% \cite{antwerpes_summation} ohne dass etwas anderes dazwischen zitiert
% wurde - laut Zitierregel korrekt als "Vgl. Ebd." zu setzen.
...
% EBD-FIX: Im Original stand hier "Vgl. \cite{qin2023}, S. 1 und 2" - die
% unmittelbar vorangehende Fußnote zitierte jedoch bereits qin2023 (S. 3),
% ohne dass etwas anderes dazwischen zitiert wurde. Nach der Zitierregel
% (dieselbe Quelle direkt hintereinander -> Ebd.) korrigiert zu "Vgl. Ebd.,
% S. 1 und 2" - analog zur bereits im Original korrekt verwendeten Form
% "Vgl. Ebd., S. 4" direkt im Anschluss.
